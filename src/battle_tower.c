...
void DoSpecialTrainerBattle(void)
{
    ...
    case SPECIAL_BATTLE_TOWER:
        ...
        BattleTransition_StartOnField(GetSpecialTrainerBattleTransition(0));
        break;
    case SPECIAL_BATTLE_SECRET_BASE:
        for (i = 0; i < PARTY_SIZE; i++)
        {
        ...
        CreateTask(Task_StartBattleAfterTransition, 1);
        PlayMapChosenOrBattleBGM(0);
        BattleTransition_StartOnField(GetSpecialTrainerBattleTransition(12));
        break;
    case SPECIAL_BATTLE_EREADER:
        ZeroEnemyPartyMons();
        for (i = 0; i < 3; i++)
        ...
        CreateTask(Task_StartBattleAfterTransition, 1);
        PlayMapChosenOrBattleBGM(0);
        BattleTransition_StartOnField(GetSpecialTrainerBattleTransition(13));
        break;
    case SPECIAL_BATTLE_DOME:
        ...
        CreateTask(Task_StartBattleAfterTransition, 1);
        sub_806E694(0);
        BattleTransition_StartOnField(GetSpecialTrainerBattleTransition(3));
        break;
    case SPECIAL_BATTLE_PALACE:
        ...
        CreateTask(Task_StartBattleAfterTransition, 1);
        PlayMapChosenOrBattleBGM(0);
        BattleTransition_StartOnField(GetSpecialTrainerBattleTransition(4));
        break;
    case SPECIAL_BATTLE_ARENA:
        ...
        CreateTask(Task_StartBattleAfterTransition, 1);
        PlayMapChosenOrBattleBGM(0);
        BattleTransition_StartOnField(GetSpecialTrainerBattleTransition(5));
        break;
    case SPECIAL_BATTLE_FACTORY:
        ...
        CreateTask(Task_StartBattleAfterTransition, 1);
        PlayMapChosenOrBattleBGM(0);
        BattleTransition_StartOnField(GetSpecialTrainerBattleTransition(6));
        break;
    case SPECIAL_BATTLE_PIKE_SINGLE:
        gBattleTypeFlags = BATTLE_TYPE_TRAINER | BATTLE_TYPE_BATTLE_TOWER;
        FillFrontierTrainerParty(FRONTIER_PARTY_SIZE);
        CreateTask(Task_StartBattleAfterTransition, 1);
        PlayMapChosenOrBattleBGM(0);
        BattleTransition_StartOnField(GetSpecialTrainerBattleTransition(7));
        break;
    case SPECIAL_BATTLE_PYRAMID:
        ...
        CreateTask(Task_StartBattleAfterTransition, 1);
        PlayMapChosenOrBattleBGM(0);
        BattleTransition_StartOnField(GetSpecialTrainerBattleTransition(10));
        break;
    case SPECIAL_BATTLE_PIKE_DOUBLE:
